...
export const Styles = StyleSheet.create({
  ...
  searchTextInput: { backgroundColor: StyleConstants.whiteColor, flex: 1, paddingHorizontal: "3%", fontSize: StyleConstants.smallFont, borderTopLeftRadius: DimensionHelper.wp("2%"), borderBottomLeftRadius: DimensionHelper.wp("2%"), elevation: 5, color: "#000" },
